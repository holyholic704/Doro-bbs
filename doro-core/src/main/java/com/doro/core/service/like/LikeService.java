...
import com.doro.mq.producer.LikeSaveProducer;
...
public class LikeService {
    ...
    private final LikeSaveProducer likeSaveProducer;

    @Autowired
    public LikeService(LikeIndexService likeIndexService, UserLikeService userLikeService, LikeSaveProducer likeSaveProducer) {
        this.likeIndexService = likeIndexService;
        this.userLikeService = userLikeService;
        this.likeSaveProducer = likeSaveProducer;
    }
    ...
    public boolean like(RequestUserLike requestUserLike) {
        ...
        likeSaveProducer.send(cacheKey, CommonConst.COMMON_DELAY_SECONDS);
